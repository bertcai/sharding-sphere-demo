...
public class ShardingAndMasterSlave {
    ...
    private static Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("demo_ds_master_0", DataSourceUtil.createDataSource("demo_ds_master_0",3300,"root","admin"));
        result.put("demo_ds_master_0_slave_0", DataSourceUtil.createDataSource("demo_ds_master_0",3302,"root",""));
        result.put("demo_ds_master_0_slave_1", DataSourceUtil.createDataSource("demo_ds_master_0",3303,"root",""));
        result.put("demo_ds_master_1", DataSourceUtil.createDataSource("demo_ds_master_1",3301,"root",""));
        result.put("demo_ds_master_1_slave_0", DataSourceUtil.createDataSource("demo_ds_master_1",3304,"root",""));
        result.put("demo_ds_master_1_slave_1", DataSourceUtil.createDataSource("demo_ds_master_1",3305,"root",""));
        return result;
    }
}
